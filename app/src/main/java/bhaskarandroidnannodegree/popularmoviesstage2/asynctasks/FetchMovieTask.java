package bhaskarandroidnannodegree.popularmoviesstage2.asynctasks;
...
import bhaskarandroidnannodegree.popularmoviesstage2.BuildConfig;
    ...
    private void getMovieDataFromJson(String movieJsonStr)
        ...
        try {
            ...
            for (int i = 0; i < movieArray.length(); i++) {
                ...
                movieValues.put(MovieContract.Movies.SORT_BY, Utils.getPreferredSorting(mContext));
