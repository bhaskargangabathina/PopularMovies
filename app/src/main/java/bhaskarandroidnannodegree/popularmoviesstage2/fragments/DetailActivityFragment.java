...
import bhaskarandroidnannodegree.popularmoviesstage2.asynctasks.FetchTrailReviewTask;
import bhaskarandroidnannodegree.popularmoviesstage2.adapters.GenreMovieAdapter;
import bhaskarandroidnannodegree.popularmoviesstage2.adapters.ReviewMovieAdapter;
import bhaskarandroidnannodegree.popularmoviesstage2.adapters.TrailerMovieAdapter;
...
public class DetailActivityFragment extends Fragment implements LoaderCallbacks<Cursor> {
    ...
    private static final String MOVIE_SHARE_HASHTAG = " #PopularMovieApp #ByBhaskar ";
    ...
    private void updateMovieList() {
        FetchTrailReviewTask weatherTask = new FetchTrailReviewTask(getActivity());
