package bhaskarandroidnannodegree.popularmoviesstage2.data;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import bhaskarandroidnannodegree.popularmoviesstage2.data.MovieContract.Favourites;
import bhaskarandroidnannodegree.popularmoviesstage2.data.MovieContract.Genres;
import bhaskarandroidnannodegree.popularmoviesstage2.data.MovieContract.Movies;
import bhaskarandroidnannodegree.popularmoviesstage2.data.MovieContract.Reviews;
import bhaskarandroidnannodegree.popularmoviesstage2.data.MovieContract.Trailers;
